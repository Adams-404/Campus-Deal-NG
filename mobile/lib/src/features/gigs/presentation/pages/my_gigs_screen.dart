          ...
          tabs: const [
            Tab(
              child: Row(
                ...
                children: [
                  FaIcon(FontAwesomeIcons.briefcase, size: 14),
                  SizedBox(width: 8),
                  Text('My Gigs', style: TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
            ),
            Tab(
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('Applied', style: TextStyle(fontWeight: FontWeight.bold)),
                ],
              ),
            ),
          ],
