...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (theme === 'light' || (theme === 'system' && !window.matchMedia('(prefers-color-scheme: dark)').matches)) {
      ...
      document.documentElement.style.setProperty('--background', '240 10% 2%'); // Even darker background
      document.documentElement.style.setProperty('--foreground', '0 0% 98%');
      document.documentElement.style.setProperty('--card', '240 10% 3%'); // Darker card
      document.documentElement.style.setProperty('--card-foreground', '0 0% 98%');
      document.documentElement.style.setProperty('--primary', '217.2 91.2% 59.8%');
      document.documentElement.style.setProperty('--primary-foreground', '210 40% 98%');
      document.documentElement.style.setProperty('--secondary', '240 3.7% 10%'); // Even darker secondary
      document.documentElement.style.setProperty('--secondary-foreground', '0 0% 98%');
      document.documentElement.style.setProperty('--muted', '240 3.7% 10%'); // Even darker muted
      document.documentElement.style.setProperty('--muted-foreground', '240 5% 64.9%');
      document.documentElement.style.setProperty('--accent', '240 3.7% 10%'); // Even darker accent
      ...
      document.documentElement.style.setProperty('--border', '240 3.7% 10%'); // Even darker border
      document.documentElement.style.setProperty('--input', '240 3.7% 10%'); // Even darker input
