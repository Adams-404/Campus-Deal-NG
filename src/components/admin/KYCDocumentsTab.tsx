            ...
            <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
              <div className="md:col-span-2 p-6 bg-secondary/30 flex flex-col justify-center">
                ...
                <Badge 
                  ...
                  className={cn(
                    "self-start my-1",
                    document.status === 'verified' && "bg-green-500/10 text-green-500 border-green-500/20",
                    document.status === 'rejected' && "bg-red-500/10 text-red-500 border-red-500/20",
                    document.status === 'processing' && "bg-orange-500/10 text-orange-500 border-orange-500/20",
                    document.status === 'pending' && "bg-yellow-500/10 text-yellow-500 border-yellow-500/20"
                  )}
                >
                  {document.status}
                </Badge>
