...
export const SellModal = ({ isOpen, onClose }: SellModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-secondary w-full max-w-lg rounded-2xl overflow-hidden animate-fadeIn">
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-4 gap-4">
              <button className="aspect-square rounded-lg border-2 border-dashed border-white/10 flex flex-col items-center justify-center gap-2 hover:border-primary/50 transition-colors">
