...
export const Navbar = () => {
  ...
  const { searchQuery, setSearchQuery, selectedCategories, setSelectedCategories, sortBy, setSortBy, useNLP, setUseNLP, isProcessingNLP, searchParams, priceRange, condition, setPriceRange, setCondition } = useSearch()
